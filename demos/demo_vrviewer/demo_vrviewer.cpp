...
void main()
{
    ...
    cv::Mat panoimg = cv::imread(R"(D:\Code\scenerender\datas\vrview\panoimage.bmp)");
    cv::Mat panodepth = cv::imread(R"(D:\Code\scenerender\datas\vrview\panodepth.png)", cv::IMREAD_ANYDEPTH);
