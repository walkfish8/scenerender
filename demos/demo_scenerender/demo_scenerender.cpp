...
void main()
{
    ...
    cameraparam.SetQuaternionRotation(0.0, 0.0, 0.6994630464255629, 0.7146687671117795);
    cameraparam.SetPositionAfterRotation(3.40076238 * scale, -8.40359721 * scale, 1.4 * scale);
    //cameraparam.SetRodriguesRotation(-CV_PI/2.0, 0.0, 0.0);
    //cameraparam.SetPositionAfterRotation(0.0 * scale, 0.0 * scale, 3.0 * scale);
    cv::Mat R = cameraparam.GetRotationMatrix();
    cv::Mat C = cameraparam.GetPositionMatrix();
